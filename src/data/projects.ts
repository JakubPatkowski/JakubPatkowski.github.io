...
export const projects: Project[] = [
  {
    ...
    images: [
      '/JakubPatkowski/projects/korepetycje-online-backend/ekorki_erd_diagram.png',
      '/JakubPatkowski/projects/korepetycje-online-backend/ekorki_frontend.png',
      '/JakubPatkowski/projects/korepetycje-online-backend/ekorki_swagger.png',
      '/JakubPatkowski/projects/korepetycje-online-backend/ekorki_tests.png',
    ],
    featured: true,
    category: 'backend',
  },
  {
    ...
    images: [
      '/JakubPatkowski/projects/todo-task-api/todo_swagger.png',
      '/JakubPatkowski/projects/todo-task-api/todo_swagger_get.png',
    ],
    featured: true,
    category: 'backend',
  },
  {
    ...
    images: [
      '/JakubPatkowski/projects/angular-laravel/home_page.png',
      '/JakubPatkowski/projects/angular-laravel/register.png',
      '/JakubPatkowski/projects/angular-laravel/login.png',
      '/JakubPatkowski/projects/angular-laravel/data_table.png'
    ],
    featured: true,
    category: 'fullstack',
  },
  {
    ...
    images: [
      '/JakubPatkowski/projects/warsaw-clustering/district_boundaries_satelite_map.png',
      '/JakubPatkowski/projects/warsaw-clustering/cluster_open_street_map.png',
      '/JakubPatkowski/projects/warsaw-clustering/heat_map.png',
      '/JakubPatkowski/projects/warsaw-clustering/report_overview.png',
    ],
    featured: true,
